use adom_protocol::items::AgentMessageContent;
use adom_protocol::items::AgentMessageItem;
use adom_protocol::items::ReasoningItem;
use adom_protocol::items::TurnItem;
use adom_protocol::items::UserMessageItem;
use adom_protocol::items::WebSearchItem;
    ...
    fn parses_agent_message() {
        let item = ResponseItem::Message {
            ...
            content: vec![ContentItem::OutputText {
                text: "Hello from Adom".to_string(),
            }],
        };
        ...
        match turn_item {
            TurnItem::AgentMessage(message) => {
                ...
                assert_eq!(text, "Hello from Adom");
            }
