...
pub struct McpServerConfig {
    ...
    /// When `false`, Adom skips initializing this MCP server.
...
/// (primarily the Adom IDE extension). NOTE: these are different from
...
impl From<SandboxWorkspaceWrite> for adom_app_server_protocol::SandboxSettings {
