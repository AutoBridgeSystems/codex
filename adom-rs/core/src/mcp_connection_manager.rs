...
//!
//! The [`McpConnectionManager`] owns one [`adom_rmcp_client::RmcpClient`] per
            ...
            join_set.spawn(async move {
                ...
                let params = mcp_types::InitializeRequestParams {
                    ...
                    client_info: Implementation {
                        name: "adom-mcp-client".to_owned(),
                        version: env!("CARGO_PKG_VERSION").to_owned(),
                        title: Some("Adom".into()),
                        // This field is used by Adom when it is an MCP
                        // server: it should not be used when Adom is
                        // an MCP client.
                        user_agent: None,
                    },
