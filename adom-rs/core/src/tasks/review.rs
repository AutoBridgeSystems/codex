...
use adom_protocol::protocol::AgentMessageContentDeltaEvent;
use adom_protocol::protocol::AgentMessageDeltaEvent;
use adom_protocol::protocol::Event;
use adom_protocol::protocol::EventMsg;
use adom_protocol::protocol::ExitedReviewModeEvent;
use adom_protocol::protocol::ItemCompletedEvent;
use adom_protocol::protocol::ReviewOutputEvent;
use tokio_util::sync::CancellationToken;

use crate::adom::Session;
use crate::adom::TurnContext;
use crate::adom_delegate::run_adom_conversation_one_shot;
...
impl SessionTask for ReviewTask {
    ...
    async fn run(
        ...
        // Start sub-adom conversation and get the receiver for events.
...
async fn start_review_conversation(
    ...
    (run_adom_conversation_one_shot(
        sub_agent_config,
