...
const GPT_5_ADOM_INSTRUCTIONS: &str = include_str!("../gpt_5_adom_prompt.md");
...
pub fn find_family_for_model(slug: &str) -> Option<ModelFamily> {
    ...
    } else if slug.starts_with("adom-mini-latest") {
        model_family!(
    ...
    } else if slug.starts_with("test-gpt-5-adom") {
        model_family!(
            slug, slug,
            supports_reasoning_summaries: true,
            reasoning_summary_format: ReasoningSummaryFormat::Experimental,
            base_instructions: GPT_5_ADOM_INSTRUCTIONS.to_string(),
    ...
    // Internal models.
    } else if slug.starts_with("adom-exp-") {
        model_family!(
            slug, slug,
            supports_reasoning_summaries: true,
            reasoning_summary_format: ReasoningSummaryFormat::Experimental,
    ...
    // Production models.
    } else if slug.starts_with("gpt-5-adom") || slug.starts_with("adom-") {
        model_family!(
            slug, slug,
            supports_reasoning_summaries: true,
            reasoning_summary_format: ReasoningSummaryFormat::Experimental,
