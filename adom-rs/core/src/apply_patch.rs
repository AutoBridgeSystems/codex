...
use adom_apply_patch::ApplyPatchAction;
use adom_apply_patch::ApplyPatchFileChange;
use std::collections::HashMap;
use std::path::PathBuf;

pub const ADOM_APPLY_PATCH_ARG1: &str = "--adom-run-as-apply-patch";
...
pub(crate) enum InternalApplyPatchInvocation {
    ...
    /// exec with [`ADOM_APPLY_PATCH_ARG1`] to realize the `apply_patch` call,
