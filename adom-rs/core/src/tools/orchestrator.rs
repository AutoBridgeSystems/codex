...
impl ToolOrchestrator {
    ...
    pub async fn run<Rq, Out, T>(
        ...
        req: &Rq,
        tool_ctx: &ToolCtx<'_>,
        turn_ctx: &crate::adom::TurnContext,
        ...
        Rq: ProvidesSandboxRetryData,
    {
        ...
        let otel_user = adom_otel::otel_event_manager::ToolDecisionSource::User;
        let otel_cfg = adom_otel::otel_event_manager::ToolDecisionSource::Config;
        ...
        let initial_attempt = SandboxAttempt {
            ...
            adom_linux_sandbox_exe: turn_ctx.adom_linux_sandbox_exe.as_ref(),
        };
        ...
        match tool.run(req, &initial_attempt, tool_ctx).await {
            ...
            Err(ToolError::Adom(AdomErr::Sandbox(SandboxErr::Denied { output }))) => {
                if !tool.escalate_on_failure() {
                    return Err(ToolError::Adom(AdomErr::Sandbox(SandboxErr::Denied {
                        output,
                    })));
                }
                ...
                if !tool.should_bypass_approval(approval_policy, already_approved) {
                    ...
                    if let Some(metadata) = req.sandbox_retry_data() {
                        ...
                        let friendly = get_error_message_ui(&AdomErr::Sandbox(err));
