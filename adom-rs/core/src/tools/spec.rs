...
fn create_test_sync_tool() -> ToolSpec {
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: "Internal synchronization helper used by Adom integration tests.".to_string(),
        strict: false,
        parameters: JsonSchema::Object {
            properties,
            required: None,
...
mod tests {
    ...
    #[test]
    fn test_full_toolset_specs_for_gpt5_adom_unified_exec_web_search() {
        let model_family = find_family_for_model("gpt-5-adom")
            .expect("gpt-5-adom should be a valid model family");
    ...
    #[test]
    fn test_build_specs_gpt5_adom_default() {
        assert_model_tools(
            "gpt-5-adom",
    ...
    #[test]
    fn test_build_specs_gpt5_adom_unified_exec_web_search() {
        assert_model_tools(
            "gpt-5-adom",
            Features::with_defaults()
    ...
    #[test]
    fn test_adom_mini_unified_exec_web_search() {
        assert_model_tools(
            "adom-mini-latest",
            Features::with_defaults()
                .enable(Feature::UnifiedExec)
    ...
    fn test_parallel_support_flags() {
        let model_family = find_family_for_model("gpt-5-adom")
            .expect("adom-mini-latest should be a valid model family");
        let mut features = Features::with_defaults();
    ...
    fn test_test_model_family_includes_sync_tool() {
        let model_family = find_family_for_model("test-gpt-5-adom")
            .expect("test-gpt-5-adom should be a valid model family");
        let mut features = Features::with_defaults();
        features.disable(Feature::ViewImageTool);
        let config = ToolsConfig::new(&ToolsConfigParams {
            model_family: &model_family,
