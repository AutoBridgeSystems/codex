...
async fn unified_exec_emits_exec_command_begin_event() -> Result<()> {
    ...
    let begin_event = wait_for_event_match(&adom, |msg| match msg {
    ...
    wait_for_event(&adom, |event| matches!(event, EventMsg::TaskComplete(_))).await;
...
async fn unified_exec_emits_exec_command_end_event() -> Result<()> {
    ...
    let end_event = wait_for_event_match(&adom, |msg| match msg {
...
async fn unified_exec_emits_output_delta_for_exec_command() -> Result<()> {
    ...
    let delta = wait_for_event_match(&adom, |msg| match msg {
...
async fn unified_exec_skips_begin_event_for_empty_input() -> Result<()> {
    ...
    loop {
        let event_msg = wait_for_event(&adom, |_| true).await;
        match event_msg {
...
async fn unified_exec_timeout_and_followup_poll() -> Result<()> {
    ...
    loop {
        let event = adom.next_event().await.expect("event");
