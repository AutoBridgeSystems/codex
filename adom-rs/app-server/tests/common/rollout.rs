...
/// Create a minimal rollout file under `ADOM_HOME/sessions/YYYY/MM/DD/`.
///
...
pub fn create_fake_rollout(
    ...
    let dir = adom_home.join("sessions").join(year).join(month).join(day);
