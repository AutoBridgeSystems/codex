...
use chrono::DateTime;
use chrono::Utc;
use adom_app_server_protocol::Account;
use adom_app_server_protocol::AccountLoginCompletedNotification;
use adom_app_server_protocol::AccountRateLimitsUpdatedNotification;
use adom_app_server_protocol::AccountUpdatedNotification;
use adom_app_server_protocol::AddConversationListenerParams;
use adom_app_server_protocol::AddConversationSubscriptionResponse;
use adom_app_server_protocol::ApplyPatchApprovalParams;
use adom_app_server_protocol::ApplyPatchApprovalResponse;
use adom_app_server_protocol::ArchiveConversationParams;
use adom_app_server_protocol::ArchiveConversationResponse;
use adom_app_server_protocol::AskForApproval;
use adom_app_server_protocol::AuthMode;
use adom_app_server_protocol::AuthStatusChangeNotification;
use adom_app_server_protocol::CancelLoginAccountParams;
use adom_app_server_protocol::CancelLoginAccountResponse;
use adom_app_server_protocol::CancelLoginChatGptResponse;
use adom_app_server_protocol::ClientRequest;
use adom_app_server_protocol::ConversationGitInfo;
use adom_app_server_protocol::ConversationSummary;
use adom_app_server_protocol::ExecCommandApprovalParams;
use adom_app_server_protocol::ExecCommandApprovalResponse;
use adom_app_server_protocol::ExecOneOffCommandParams;
use adom_app_server_protocol::ExecOneOffCommandResponse;
use adom_app_server_protocol::FeedbackUploadParams;
use adom_app_server_protocol::FeedbackUploadResponse;
use adom_app_server_protocol::FuzzyFileSearchParams;
use adom_app_server_protocol::FuzzyFileSearchResponse;
use adom_app_server_protocol::GetAccountParams;
use adom_app_server_protocol::GetAccountRateLimitsResponse;
use adom_app_server_protocol::GetAccountResponse;
use adom_app_server_protocol::GetAuthStatusParams;
use adom_app_server_protocol::GetAuthStatusResponse;
use adom_app_server_protocol::GetConversationSummaryParams;
use adom_app_server_protocol::GetConversationSummaryResponse;
use adom_app_server_protocol::GetUserAgentResponse;
use adom_app_server_protocol::GetUserSavedConfigResponse;
use adom_app_server_protocol::GitDiffToRemoteResponse;
use adom_app_server_protocol::InputItem as WireInputItem;
use adom_app_server_protocol::InterruptConversationParams;
use adom_app_server_protocol::InterruptConversationResponse;
use adom_app_server_protocol::JSONRPCErrorError;
use adom_app_server_protocol::ListConversationsParams;
use adom_app_server_protocol::ListConversationsResponse;
use adom_app_server_protocol::LoginAccountParams;
use adom_app_server_protocol::LoginApiKeyParams;
use adom_app_server_protocol::LoginApiKeyResponse;
use adom_app_server_protocol::LoginChatGptCompleteNotification;
use adom_app_server_protocol::LoginChatGptResponse;
use adom_app_server_protocol::LogoutAccountResponse;
use adom_app_server_protocol::LogoutChatGptResponse;
use adom_app_server_protocol::ModelListParams;
use adom_app_server_protocol::ModelListResponse;
use adom_app_server_protocol::NewConversationParams;
use adom_app_server_protocol::NewConversationResponse;
use adom_app_server_protocol::RemoveConversationListenerParams;
use adom_app_server_protocol::RemoveConversationSubscriptionResponse;
use adom_app_server_protocol::RequestId;
use adom_app_server_protocol::Result as JsonRpcResult;
use adom_app_server_protocol::ResumeConversationParams;
use adom_app_server_protocol::ResumeConversationResponse;
use adom_app_server_protocol::SandboxMode;
use adom_app_server_protocol::SendUserMessageParams;
use adom_app_server_protocol::SendUserMessageResponse;
use adom_app_server_protocol::SendUserTurnParams;
use adom_app_server_protocol::SendUserTurnResponse;
use adom_app_server_protocol::ServerNotification;
use adom_app_server_protocol::ServerRequestPayload;
use adom_app_server_protocol::SessionConfiguredNotification;
use adom_app_server_protocol::SetDefaultModelParams;
use adom_app_server_protocol::SetDefaultModelResponse;
use adom_app_server_protocol::Thread;
use adom_app_server_protocol::ThreadArchiveParams;
use adom_app_server_protocol::ThreadArchiveResponse;
use adom_app_server_protocol::ThreadItem;
use adom_app_server_protocol::ThreadListParams;
use adom_app_server_protocol::ThreadListResponse;
use adom_app_server_protocol::ThreadResumeParams;
use adom_app_server_protocol::ThreadResumeResponse;
use adom_app_server_protocol::ThreadStartParams;
use adom_app_server_protocol::ThreadStartResponse;
use adom_app_server_protocol::ThreadStartedNotification;
use adom_app_server_protocol::Turn;
use adom_app_server_protocol::TurnInterruptParams;
use adom_app_server_protocol::TurnInterruptResponse;
use adom_app_server_protocol::TurnStartParams;
use adom_app_server_protocol::TurnStartResponse;
use adom_app_server_protocol::TurnStartedNotification;
use adom_app_server_protocol::TurnStatus;
use adom_app_server_protocol::UserInfoResponse;
use adom_app_server_protocol::UserInput as V2UserInput;
use adom_app_server_protocol::UserSavedConfig;
use adom_backend_client::Client as BackendClient;
use adom_core::AuthManager;
use adom_core::AdomConversation;
use adom_core::ConversationManager;
use adom_core::Cursor as RolloutCursor;
use adom_core::INTERACTIVE_SESSION_SOURCES;
use adom_core::InitialHistory;
use adom_core::NewConversation;
use adom_core::RolloutRecorder;
use adom_core::SessionMeta;
use adom_core::auth::CLIENT_ID;
use adom_core::auth::login_with_api_key;
use adom_core::config::Config;
use adom_core::config::ConfigOverrides;
use adom_core::config::ConfigToml;
use adom_core::config::edit::ConfigEditsBuilder;
use adom_core::config_loader::load_config_as_toml;
use adom_core::default_client::get_adom_user_agent;
use adom_core::exec::ExecParams;
use adom_core::exec_env::create_env;
use adom_core::find_conversation_path_by_id_str;
use adom_core::get_platform_sandbox;
use adom_core::git_info::git_diff_to_remote;
use adom_core::parse_cursor;
use adom_core::protocol::ApplyPatchApprovalRequestEvent;
use adom_core::protocol::Event;
use adom_core::protocol::EventMsg;
use adom_core::protocol::ExecApprovalRequestEvent;
use adom_core::protocol::Op;
use adom_core::protocol::ReviewDecision;
use adom_core::read_head_for_summary;
use adom_feedback::AdomFeedback;
use adom_login::ServerOptions as LoginServerOptions;
use adom_login::ShutdownHandle;
use adom_login::run_login_server;
use adom_protocol::ConversationId;
use adom_protocol::config_types::ForcedLoginMethod;
use adom_protocol::items::TurnItem;
use adom_protocol::models::ResponseItem;
use adom_protocol::protocol::GitInfo;
use adom_protocol::protocol::RateLimitSnapshot as CoreRateLimitSnapshot;
use adom_protocol::protocol::RolloutItem;
use adom_protocol::protocol::SessionMetaLine;
use adom_protocol::protocol::USER_MESSAGE_BEGIN;
use adom_protocol::user_input::UserInput as CoreInputItem;
...
/// Handles JSON-RPC messages for Adom conversations.
pub(crate) struct AdomMessageProcessor {
...
impl AdomMessageProcessor {
    ...
    async fn login_api_key_v2(&mut self, request_id: RequestId, params: LoginApiKeyParams) {
        match self.login_api_key_common(&params).await {
            Ok(()) => {
                let response = adom_app_server_protocol::LoginAccountResponse::ApiKey {};
        ...
        match self.login_chatgpt_common().await {
            Ok(opts) => match run_login_server(opts) {
                Ok(server) => {
                    ...
                    let response = adom_app_server_protocol::LoginAccountResponse::Chatgpt {
    ...
    async fn fetch_account_rate_limits(&self) -> Result<CoreRateLimitSnapshot, JSONRPCErrorError> {
        let Some(auth) = self.auth_manager.auth() else {
            return Err(JSONRPCErrorError {
                code: INVALID_REQUEST_ERROR_CODE,
                message: "adom account authentication required to read rate limits".to_string(),
                data: None,
            });
        };
        ...
        client
            ...
            .map_err(|err| JSONRPCErrorError {
                code: INTERNAL_ERROR_CODE,
                message: format!("failed to fetch adom rate limits: {err}"),
                data: None,
            })
    }

    async fn get_user_saved_config(&self, request_id: RequestId) {
        let toml_value = match load_config_as_toml(&self.config.adom_home).await {
            Ok(val) => val,
            Err(err) => {
                let error = JSONRPCErrorError {
                    code: INTERNAL_ERROR_CODE,
    ...
    async fn set_default_model(&self, request_id: RequestId, params: SetDefaultModelParams) {
        ...
        match ConfigEditsBuilder::new(&self.config.adom_home)
    ...
    async fn exec_one_off_command(&self, request_id: RequestId, params: ExecOneOffCommandParams) {
        ...
        let sandbox_type = match &effective_policy {
            adom_core::protocol::SandboxPolicy::DangerFullAccess => {
                adom_core::exec::SandboxType::None
            }
            _ => get_platform_sandbox().unwrap_or(adom_core::exec::SandboxType::None),
        };
        tracing::debug!("Sandbox type: {sandbox_type:?}");
        let adom_linux_sandbox_exe = self.config.adom_linux_sandbox_exe.clone();
        let outgoing = self.outgoing.clone();
        let req_id = request_id;
        let sandbox_cwd = self.config.cwd.clone();

        tokio::spawn(async move {
            match adom_core::exec::process_exec_tool_call(
                exec_params,
                sandbox_type,
                &effective_policy,
                sandbox_cwd.as_path(),
    ...
    async fn process_new_conversation(&self, request_id: RequestId, params: NewConversationParams) {
        ...
        let overrides = ConfigOverrides {
            ...
            sandbox_mode,
            model_provider,
            adom_linux_sandbox_exe: self.adom_linux_sandbox_exe.clone(),
            base_instructions,
            developer_instructions,
            compact_prompt,
            include_apply_patch_tool,
        ...
        let path = match params {
            GetConversationSummaryParams::RolloutPath { rollout_path } => {
                if rollout_path.is_relative() {
                    self.config.adom_home.join(&rollout_path)
                } else {
                    rollout_path
                }
            }
            GetConversationSummaryParams::ConversationId { conversation_id } => {
                match adom_core::find_conversation_path_by_id_str(
                    &self.config.adom_home,
                    &conversation_id.to_string(),
                )
                .await
    ...
    async fn archive_conversation_common(
        ...
        let rollout_folder = self.config.adom_home.join(adom_core::SESSIONS_SUBDIR);
        ...
        let result: std::io::Result<()> = async {
            let archive_folder = self
                .config
                .adom_home
                .join(adom_core::ARCHIVED_SESSIONS_SUBDIR);
            ...
            loop {
                tokio::select! {
                    ...
                    event = conversation.next_event() => {
                        ...
                        // instead.
                        let method = format!("adom/event/{}", event.msg);
...
async fn apply_bespoke_event_handling(
    event: Event,
    conversation_id: ConversationId,
    conversation: Arc<AdomConversation>,
    outgoing: Arc<OutgoingMessageSender>,
    pending_interrupts: PendingInterrupts,
) {
...
async fn on_exec_approval_response(
    ...
    // Try to deserialize `value` and then make the appropriate call to `adom`.
    let response =
...
fn extract_conversation_summary(
    ...
    let preview = head
        ...
        .find_map(|item| match adom_core::parse_turn_item(&item) {
...
mod tests {
    ...
    async fn read_summary_from_rollout_returns_empty_preview_when_no_user_message() -> Result<()> {
        use adom_protocol::protocol::RolloutItem;
        use adom_protocol::protocol::RolloutLine;
        use adom_protocol::protocol::SessionMetaLine;
        use std::fs;
