...
#[derive(Clone)]
pub struct AdomFeedback {
    inner: Arc<FeedbackInner>,
}

impl Default for AdomFeedback {
    fn default() -> Self {
        Self::new()
    }
}
...
impl AdomFeedback {
    ...
    pub fn snapshot(&self, session_id: Option<ConversationId>) -> AdomLogSnapshot {
        let bytes = {
...
pub struct AdomLogSnapshot {
    bytes: Vec<u8>,
    pub thread_id: String,
}

impl AdomLogSnapshot {
    ...
    pub fn save_to_temp_file(&self) -> io::Result<PathBuf> {
        ...
        let filename = format!("adom-feedback-{}.log", self.thread_id);
    ...
    pub fn upload_feedback(
        ...
        if include_logs {
            envelope.add_item(EnvelopeItem::Attachment(Attachment {
                ...
                filename: String::from("adom-logs.log"),
...
mod tests {
    ...
    fn ring_buffer_drops_front_when_full() {
        let fb = AdomFeedback::with_capacity(8);
        {
