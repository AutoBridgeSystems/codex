...
use adom_rmcp_client::RmcpClient;
...
const RESOURCE_URI: &str = "memo://adom/example-note";
...
fn init_params() -> InitializeRequestParams {
    InitializeRequestParams {
        ...
        client_info: Implementation {
            ...
            title: Some("Adom rmcp resource test".into()),
            user_agent: None,
        },
    ...
    assert_eq!(
        ...
        ListResourceTemplatesResult {
            ...
            resource_templates: vec![ResourceTemplate {
                annotations: None,
                description: Some(
                    "Template for memo://adom/{slug} resources used in tests.".to_string()
                ),
                mime_type: Some("text/plain".to_string()),
                name: "adom-memo".to_string(),
                title: Some("Adom Memo".to_string()),
                uri_template: "memo://adom/{slug}".to_string(),
            }],
        }
    );
