...
use adom_protocol::protocol::SandboxCommandAssessment;
use paste::paste;
...
client_request_definitions! {
    ...
    /// List recorded Adom conversations (rollouts) with optional pagination and search.
    ListConversations {
        params: v1::ListConversationsParams,
        response: v1::ListConversationsResponse,
    },
    /// Resume a recorded Adom conversation from a rollout file.
    ResumeConversation {
...
pub struct ApplyPatchApprovalParams {
    ...
    /// Use to correlate this with [adom_core::protocol::PatchApplyBeginEvent]
    /// and [adom_core::protocol::PatchApplyEndEvent].
    pub call_id: String,
...
pub struct ExecCommandApprovalParams {
    pub conversation_id: ConversationId,
    /// Use to correlate this with [adom_core::protocol::ExecCommandBeginEvent]
    /// and [adom_core::protocol::ExecCommandEndEvent].
    pub call_id: String,
...
/// Superset of [`adom_file_search::FileMatch`]
#[derive(Serialize, Deserialize, Debug, Clone, PartialEq, JsonSchema, TS)]
