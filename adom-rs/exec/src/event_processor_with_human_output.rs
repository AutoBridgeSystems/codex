use adom_common::elapsed::format_duration;
use adom_common::elapsed::format_elapsed;
...
use adom_protocol::num_format::format_with_separators;
...
use crate::event_processor::AdomStatus;
use crate::event_processor::EventProcessor;
use crate::event_processor::handle_last_message;
use adom_common::create_config_summary_entries;
...
pub(crate) struct EventProcessorWithHumanOutput {
    ...
    last_total_token_usage: Option<adom_core::protocol::TokenUsageInfo>,
...
impl EventProcessor for EventProcessorWithHumanOutput {
    ...
    fn print_config_summary(
        ...
        ts_msg!(
            self,
            "OpenAI Adom v{} (research preview)\n--------",
            VERSION
        );
    ...
    fn process_event(&mut self, event: Event) -> AdomStatus {
        ...
        match msg {
            ...
            EventMsg::TaskComplete(TaskCompleteEvent { last_agent_message }) => {
                ...
                return AdomStatus::InitiateShutdown;
            }
            ...
            EventMsg::AgentMessage(AgentMessageEvent { message }) => {
                ts_msg!(
                    self,
                    "{}\n{}",
                    "adom".style(self.italic).style(self.magenta),
                    message,
                );
            }
            ...
            EventMsg::SessionConfigured(session_configured_event) => {
                ...
                ts_msg!(
                    self,
                    "{} {}",
                    "adom session".style(self.magenta).style(self.bold),
            ...
            EventMsg::ShutdownComplete => return AdomStatus::Shutdown,
