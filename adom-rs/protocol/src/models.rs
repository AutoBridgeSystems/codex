...
use base64::Engine;
use adom_utils_image::load_and_resize_to_fit;
...
use adom_utils_image::error::ImageProcessingError;
...
fn local_image_error_placeholder(
    ...
    ContentItem::InputText {
        text: format!(
            "Adom could not read the local image at `{}`: {}",
            path.display(),
            error
        ),
    }
...
// (Moved event mapping logic into adom-core to avoid coupling protocol to UI-facing events.)
